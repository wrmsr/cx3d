...
import static ini.cx3d.utilities.Matrix.det;
...
//	private Integer transactionID = null;
     ...
     *
     * @param <T> The type of the user object stored in the incident nodes.
     * @param a The first incident node.
     * @param b The second incident node.
     * @param c The third incident node.
     * @param d The fourth incident node.
    ...
    public static <T> Tetrahedron<T> createInitialTetrahedron(SpaceNode<T> a,
            SpaceNode<T> b, SpaceNode<T> c, SpaceNode<T> d, CacheManager<T> cm)
     ...
     *
     * @param oneTriangle The triangle delivering 3 of the new tetrahedron's endpoints.
     * @param fourthPoint The fourth endpoint of the new tetrahedron.
     * @param org An organizer for open triangles which is used to keep track of
     * newly created triangles.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    public Tetrahedron(Triangle3D<T> oneTriangle, SpaceNode<T> fourthPoint,
            OpenTriangleOrganizer<T> org, CacheManager<T> cm)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @param triangleC The third triangle.
     * @param triangleD The fourth triangle.
     * @param nodeA The first point, must lie opposite to triangleA.
     * @param nodeB The first point, must lie opposite to triangleB.
     * @param nodeC The first point, must lie opposite to triangleC.
     * @param nodeD The first point, must lie opposite to triangleD.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    public Tetrahedron(Triangle3D<T> triangleA, Triangle3D<T> triangleB,
            ...
            SpaceNode<T> nodeD, CacheManager<T> cm)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @param org An organizer for open triangles which is used to keep track of
     * newly created triangles.
     * @param som The SpatialOrganizationManager that own this ManagedObject.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    public Tetrahedron(Triangle3D<T> oneTriangle, SpaceNode<T> fourthPoint,
            OpenTriangleOrganizer<T> org, SpatialOrganizationManager<T> som, CacheManager<T> cm)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        initTracker(cm, som);
    ...
    public Tetrahedron(Triangle3D<T> triangleA, Triangle3D<T> triangleB,
            Triangle3D<T> triangleC, Triangle3D<T> triangleD,
            SpaceNode<T> nodeA, SpaceNode<T> nodeB, SpaceNode<T> nodeC,
            SpaceNode<T> nodeD, SpatialOrganizationManager<T> som, CacheManager<T> cm)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        // no som specified...
        if (som == null) {
...
//			allTetrahedra.add(this);
     ...
     *
     * @param number The index of the edge which cross section area should be
     * changed.
     * @param newValue The new value for the cross section area of the specified
     * edge.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
     ...
     *
     * @param position The position for which the orientation should be determined.
     ...
     *
     * @param values The array which should be searched.
     ...
     *
     * @param values1 The first array to be searched.
     * @param values2 The second array to be searched.
     * @param values3 The third array to be searched.
     * @param values4 The fourth array to be searched.
     ...
     *
     * @param point The point for which the orientation should be determined.
     * @return -1, if the point lies outside this tetrahedron's circumsphere, 1
     * if it is inside the sphere and 0, if it lies on the surface of
     * the sphere.
     * @throws ManagedObjectDoesNotExistException
     ...
     *
     * @param oldTriangle The triangle that should be replaced.
     * @param newTriangle The new trianlge.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
     ...
     *
     * @param nodeNumber1 The index of the first endpoint of the edge.
     * @param nodeNumber2 The index of the second endpoint of the edge.
     ...
     * @throws NodeLockedException
     */
    protected Edge<T> getEdge(int nodeNumber1, int nodeNumber2)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @throws NodeLockedException
     */
    protected int getEdgeNumber(SpaceNode<T> a, SpaceNode<T> b)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @throws NodeLockedException
     */
    protected Edge<T> getEdge(SpaceNode<T> a, SpaceNode<T> b)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * tetrahedron.
     *
     * @param node An endpoint of this tetrahedron.
     * @return A reference to the triangle that lies opposite to
     * <code>node</code>.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    protected Triangle3D<T> getOppositeTriangle(SpaceNode<T> node)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (node == null) {
            for (int i = 0; i < 4; i++) {
     ...
     * to this tetrahedron.
     *
     * @param triangle An incident triangle of this tetrahedron.
     * @return The endpoint of this triangle that lies opposite to
     * <code>triangle</code>.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    protected SpaceNode<T> getOppositeNode(Triangle3D<T> triangle)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (triangle == null) {
            for (int i = 0; i < 4; i++) {
     ...
     * another one.
     *
     * @param tetrahedron An adjacent tetrahedron.
     * @return The triangle which is incident to this tetrahedron and
     * <code>tetrahedron</code>.
     */
    protected Triangle3D<T> getConnectingTriangle(Tetrahedron<T> tetrahedron)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        for (int i = 0; i < 4; i++) {
     ...
     * @throws NodeLockedException
     */
    protected int getConnectingTriangleNumber(Tetrahedron<T> tetrahedron)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        for (int i = 0; i < 4; i++) {
            if (getAdjacentTriangle(i).isAdjacentTo(tetrahedron)) {
     ...
     * triangle.
     *
     * @param base A triangle which is incident to this tetrahedron.
     * @return An array of three triangles.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    protected Triangle3D<T>[] getTouchingTriangles(Triangle3D<T> base)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     *
     * @param nodeA A first incident node.
     * @param nodeB A second incident node.
     * @return A third incident node.
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
     */
    private SpaceNode<T> getFirstOtherNode(SpaceNode<T> nodeA, SpaceNode<T> nodeB)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @throws NodeLockedException
     */
    private SpaceNode<T> getSecondOtherNode(SpaceNode<T> nodeA, SpaceNode<T> nodeB)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        ManagedObjectReference<T> refA = (nodeA == null) ? null : nodeA.getReference();
        ManagedObjectReference<T> refB = (nodeB == null) ? null : nodeB.getReference();
     ...
     *
     * @param point The coordinate that should be tested.
     * @param connectingTriangleNumber The index of the triangle facing the coordinate.
     ...
     *
     * @param <T> The type of the user objects stored in the given tetrahedra.
     * @param tetrahedronA The first flat tetrahedron.
     * @param tetrahedronB The second flat tetrahedron.
     ...
     * @throws NodeLockedException
     */
    protected Edge<T> getAdjacentEdge(int number)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @throws NodeLockedException
     */
    protected SpaceNode<T> getAdjacentNode(int number)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     * @throws NodeLockedException
     */
    protected Triangle3D<T> getAdjacentTriangle(int number)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (adjacentTriangles[number] == null) {
            return null;
     ...
     * @throws NodeLockedException
     */
    protected Triangle3D<T>[] getAdjacentTriangles()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     *
     * @param coordinate The coordinate that should be approximated.
     ...
     * @throws NodeLockedException
     */
    public boolean isNeighbor(Tetrahedron<T> otherTetrahedron)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
...
//	}
     ...
     */
    public Tetrahedron<T> getLocalCopy()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
