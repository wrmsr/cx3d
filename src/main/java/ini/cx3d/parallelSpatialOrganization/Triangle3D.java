...
//	private Integer transactionID = null;
    ...
    Tetrahedron<T> getFirstAdjacentTetrahedron()
    ...
    Tetrahedron<T> getSecondAdjacentTetrahedron()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     *
     */
    public Rational getSDDistanceExact(double[] fourthPoint)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {// , double[]
        // occupiedSide)
        // {
    ...
    protected SpaceNode<T> getNode(int number)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (nodes[number] == null) {
            ...
            return tracker.organizeNode(nodes[number]);
        }
    }
...
//	
     ...
     */
    public Triangle3D<T> getLocalCopy()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
