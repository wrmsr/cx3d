...
//	}
     ...
     */
    public static <T> OpenTriangleOrganizer<T> createSimpleOpenTriangleOrganizer(CacheManager<T> cm)
    {//SpatialOrganizationManager<T> som) {
     ...
     * organizer, an instance of {@link SimpleTriangulationNodeOrganizer} is used
     * and the number of open triangles that will approximately be used is set
     * to 30. Unlike {@link #createSimpleOpenTriangleOrganizer()}, this function allows to specify a SpatialOrganizationManager
...
//	}
        ...
        while (!nodes.isEmpty()) {
            if (searchNode == null
                ...
                if (NewDelaunayTest.createOutput()) {
                    NewDelaunayTest.out("sortCircleNodes");
                }
            }
            ...
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        ...
        if (NewDelaunayTest.createOutput()) {
            NewDelaunayTest.out("triangulating points on Circle: "
            ...
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        ...
        if (NewDelaunayTest.createOutput()) {
            NewDelaunayTest.out("triangulating points on sphere: "
                    + nodes);
        }
        ...
        if (onCircleNodes.isEmpty()) {
            ...
            if (NewDelaunayTest.createOutput()) {
                NewDelaunayTest.out("Special case: starting triangle "
                        + startingTriangle
...
//													.getPosition());
            ...
            if (pickedNode == null
                ...
                if (pickedNode != null && pickedNode.getId() == 12) {
                    if (NewDelaunayTest.createOutput()) {
                        NewDelaunayTest.out("triangulate");
                    }
                }
