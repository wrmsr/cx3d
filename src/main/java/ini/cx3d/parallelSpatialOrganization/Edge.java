...
//	private Integer transactionID = null;
    ...
    public Edge(SpaceNode<T> a, SpaceNode<T> b, SpatialOrganizationManager<T> som, CacheManager<T> cm)
    {
        ...
        if (a != null) {
            a.addEdge(this.getReference());
        }
        if (b != null) {
            b.addEdge(this.getReference());
        }
...
//		this.posB = (b!=null)?b.addEdge(this):null;
     ...
     */
    public SpaceNode<T> getOpposite(SpaceNode<T> comingFrom)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (comingFrom == null) {
            if (a == null) {
                ...
                throw new UnknownManagedObjectException("The edge " + this + " is not adjacent to the node " + comingFrom);
            }
        }
        else {
