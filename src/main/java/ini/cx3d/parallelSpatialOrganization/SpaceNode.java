...
//	
     ...
     * a user object.
     *
     * @param position The position for this SpaceNode.
     * @param content The user object that should be associated with this SpaceNode.
     * @param som The SpatialOrganizationManager that owns this ManagedObject.
     */
     ...
     * a user object.
     *
     * @param x The x-coordinate for this SpaceNode.
     * @param y The y-coordinate for this SpaceNode.
     * @param z The z-coordinate for this SpaceNode.
     * @param content The user object that should be associated with this SpaceNode.
     * @param som The SpatialOrganizationManager that owns this ManagedObject.
     */
     ...
     * SpaceNode.
     *
     * @param oppositeNode The other node to which the required edge should be connected
     * to.
     ...
     */
    protected Edge<T> searchEdge(SpaceNode<T> oppositeNode, SpatialOrganizationManager<T> som)
...
//		ManagedObjectReference<T> ref = (oppositeNode == null)?null:oppositeNode.getReference();
        for (Edge<T> e : this.getAdjacentEdges()) {
            if (e.getOpposite(this) == oppositeNode) {
                return e;
            }
        }
     ...
     *
     * @param tetrahedron The tetrahedron to be remobed.
     */
...
//	}
     ...
     *
     * @param change The change value that will be added to the volume.
     */
    ...
    public SpaceNode<T> getNewInstance(double[] position,
            T userObject, ManagedObjectReference<T> nodeReference)
     ...
     * list.
     *
     * @param listeners The movement listeners that are listening to this node's
     * movements.
     */
    ...
    public Tetrahedron<T> getFirstAdjacentTetrahedron()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        if (adjacentTetrahedra.isEmpty()) {
            return null;
...
//				listener.nodeRemoved(this);
     ...
     *
     * @param <T> The type of user objects that are associated to nodes in the
     * current triangulation.
     * @param start The starting tetrahedron.
     * @param coordinate The coordinate of interest.
     * @return A tetrahedron which contains the position of this node.
     * @throws PositionNotAllowedException
     * @throws ManagedObjectDoesNotExistException
     * @throws NodeLockedException
...
//				listener.nodeAdded(this);
            ...
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
        ...
        while (activeTetrahedra != null && !activeTetrahedra.isEmpty()) {
            ...
            if (!messedUpTetrahedra.isEmpty()) {
                cleanUp(messedUpTetrahedra);
            }
     ...
     */
    public void moveFrom(double[] delta)
            throws PositionNotAllowedException, NodeLockedException, ManagedObjectDoesNotExistException
    {
...
//					listener.nodeMoved(this);
            ...
            if (!insertPosition.isValid()) {
                insertPosition = aNewTetrahedron;
            }
     ...
     * @throws NodeLockedException
     */
    public LinkedList<Edge<T>> getAdjacentEdges()
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
