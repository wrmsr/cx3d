...
//    }
     ...
     */
    public Tetrahedron<T> tryToGetTetrahedron(ManagedObjectReference<T> ref)
     ...
     */
    public SpaceNode<T> tryToGetNode(ManagedObjectReference<T> ref)
            throws NodeLockedException, ManagedObjectDoesNotExistException
    {
     ...
     */
    public SpaceNode<T> getNode(ManagedObjectReference<T> ref)
            throws NodeLockedException
    {
        SpaceNode<T> node = nodes.get(ref);
        if (node != null) {
...
//    }
     ...
     * TODO Look at this again, regarding remote locking of ManagedObjects
     */
    public Tetrahedron<T> getTetrahedron(ManagedObjectReference<T> ref)
            throws NodeLockedException
    {
        Tetrahedron<T> tet = tetrahedra.get(ref);
        if (tet != null) {
...
//     }
     ...
     *
     * @param ref global reference to the rerquested Triangle3D
     * TODO Look at this again, regarding remote locking of ManagedObjects
     */
    public Triangle3D<T> getTriangle(ManagedObjectReference<T> ref)
            throws NodeLockedException
    {
...
//     }
     ...
     * TODO Look at this again, regarding remote locking of ManagedObjects
     */
    public Edge<T> getEdge(ManagedObjectReference<T> ref)
            throws NodeLockedException
    {
