 ...
 */
public class SpatialOrganizationManager<T>
        ...
        synchronized (actionQueue) {
            while ((activeProcesses < maxParallelActiveProcesses) &&
                ...
                if (value != null) {
                    ...
                    activePs.put(new Long(action.getID()), new Integer(1));
                }
...
//	}
     ...
     */
    SpaceNode<T> findNode(ManagedObjectReference<T> ref)
...
//		}
     ...
     * @throws RuntimeException if the object belongs to a different SOM.
     */
    Tetrahedron<T> findTetrahedron(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
     ...
     * @throws RuntimeException if the object belongs to a different SOM.
     */
    Triangle3D<T> findTriangle(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
     ...
     * @throws RuntimeException if the object belongs to a different SOM.
     */
    Edge<T> findEdge(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
        Edge<T> edge = null;
        synchronized (edges) {
...
//						}
            ...
            return vma.getSOM().getCopyOfTetrahedron(vma, customer);
        }
    }
...
//							customer.cacheNode(copy);
            ...
            return vma.getSOM().getCopyOfTriangle(vma, customer);
        }
    }
...
//						customer.cacheNode(copy);
            ...
            return vma.getSOM().getCopyOfEdge(vma, customer);
        }
    }
    ...
    public long getUniqueAddress()
    {
        ...
        if (current < maxAddress) {
            ...
            theLogger.finest("This SpatialOrganizationManager exceeded it's amount of addresses!");
     ...
     * @throws ManagedObjectDoesNotExistException
     */
    public void unlockNode(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
        SpaceNode<T> node = null;
        synchronized (nodes) {
     ...
     * @throws ManagedObjectDoesNotExistException
     */
    public void unlockTetrahedron(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
     ...
     * @throws ManagedObjectDoesNotExistException
     */
    public void unlockTriangle(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
     ...
     * @throws ManagedObjectDoesNotExistException
     */
    public void unlockEdge(ManagedObjectReference<T> ref)
            throws ManagedObjectDoesNotExistException
    {
        findEdge(ref).unlock();
    }
    ...
    public void commitNode(CacheManager<T> transaction, SpaceNode<T> obj)
    {
        ...
        if (belongsToThisSOM(ref)) {
            ...
            ref.getSOM().commitNode(transaction, obj);
        }
    }
    ...
    public void commitTetrahedron(CacheManager<T> transaction, Tetrahedron<T> obj)
    {
        ...
        if (belongsToThisSOM(ref)) {
            ...
            ref.getSOM().commitTetrahedron(transaction, obj);
        }
    }
...
//					}
            ...
            ref.getSOM().commitTriangle(transaction, obj);
        }
    }
    ...
    public void commitEdge(CacheManager<T> transaction, Edge<T> obj)
    {
        ...
        if (belongsToThisSOM(ref)) {
            ...
            ref.getSOM().commitEdge(transaction, obj);
        }
    }
...
//	}
     ...
     */
    public double[] getNodePosition(ManagedObjectReference<T> nodeReference)
            throws ManagedObjectDoesNotExistException
    {
...
//		}
    ...
    public double getNodeVolume(ManagedObjectReference<T> nodeReference)
            throws ManagedObjectDoesNotExistException
    {
    ...
    public T getNodeUserObject(ManagedObjectReference<T> nodeReference)
            throws ManagedObjectDoesNotExistException
    {
        //if (nodeReference.getSOM().getUniqueSOMID() != getUniqueSOMID()){
        //if (!nodeReference.getSOM().equals(getThis())) {
