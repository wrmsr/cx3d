...
public class TestPSO
{
    ...
    public void checkConvexHull(SpatialOrganizationManager<Integer> som)
...
//		if (Tetrahedron.allTetrahedra != null)
    ...
    public static boolean checkTetrahedronForDelaunayViolation(
            Tetrahedron<Integer> tetrahedron, SpatialOrganizationManager<Integer> som)
            throws NodeLockedException,
            ManagedObjectDoesNotExistException
    {
...
//								}
    ...
    public boolean runSeed(long seed)
    {
        ...
        if (completedTill == this.movesPerRun) {
            return true;
        }
        else {
